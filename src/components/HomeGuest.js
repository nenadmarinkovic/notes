      ...
      <Page title="Welcome!" wide={true}>
        <div className="row align-items-center">
          <div className="col-lg-7 py-3 py-md-5">
            <h1 className="display-3 dis-mobile">See what your friends are sharing</h1>
            <p className="text-small">
            Notes Café is a community of people who share knowledge, ideas, and resources. Everyone is welcome to join. It's free, fun to use, and amazingly fast.
            </p>
          </div>
