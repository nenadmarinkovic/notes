  ...
  return (
    <Page title="About Us">
      ...
      >
        ...
        to all who want to use it or contribute to its growth. Users can add
        notes, follow other users, share knowledge and resources. There are no
        distractions, trolls, marketing campaigns, political propaganda, bots,
        not even your aunt. Just a group of friends who share ideas and
        interesting links.
      </p>
